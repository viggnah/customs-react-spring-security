...
import com.tra.customs.entity.*;
import com.tra.customs.repository.AuthorityRepository;
import com.tra.customs.repository.RoleRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeUsers() {
        // Admin User
        if (!userRepository.existsByUsername("admin.tra")) {
            User admin = new User("admin.tra", passwordEncoder.encode("admin123"), "admin@tra.gov", "Admin", "User");
        ...
        if (!userRepository.existsByUsername("john.smith")) {
            User customsOfficer = new User("john.smith", passwordEncoder.encode("customs123"), "john.smith@tra.gov", "John", "Smith");
        ...
        if (!userRepository.existsByUsername("jane.doe")) {
            User cargoInspector = new User("jane.doe", passwordEncoder.encode("cargo123"), "jane.doe@tra.gov", "Jane", "Doe");
        ...
        if (!userRepository.existsByUsername("mike.wilson")) {
            User vehicleInspector = new User("mike.wilson", passwordEncoder.encode("vehicle123"), "mike.wilson@tra.gov", "Mike", "Wilson");
