...
public class EmailService {
    ...
    @Value("${spring.mail.from:noreply@tra.gov}")
    ...
    public void sendPasswordResetEmail(String toEmail, String username, String token) {
        ...
        System.out.println("Subject: TRA Customs - Password Reset Request");
        System.out.println("Content:");
        System.out.println("Dear " + username + ",");
        System.out.println();
        System.out.println("You have requested to reset your password for the TRA Customs Management System.");
        ...
        System.out.println("TRA Customs System Team");
        System.out.println("============================");
        ...
        message.setSubject("TRA Customs - Password Reset Request");
    ...
    public void sendWelcomeEmail(String toEmail, String username, String temporaryPassword) {
        ...
        System.out.println("To: " + toEmail);
        System.out.println("From: " + fromEmail);
        System.out.println("Subject: Welcome to TRA Customs Management System");
        System.out.println("Content:");
        System.out.println("Dear " + username + ",");
        System.out.println();
        System.out.println("Welcome to the TRA Customs Management System!");
